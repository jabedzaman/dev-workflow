...
-- Function to update the widget's content
...
local spotify_timer = timer({ timeout = 2 })
...
awful.rules.rules = {
    ...
    {
        rule = { class = "discord" },
        properties = { screen = 1, tag = "9", urgent = false }
    },
    -- Set Spotify to always map on the tag named "8" on screen 1.
    {
        rule = { class = "Spotify" },
        properties = { screen = 1, tag = "8", urgent = false }
    },
}
-- }}}
