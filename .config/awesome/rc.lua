...
--    {description = "surf web browser" , group = "gui apps" }),
    ...
    awful.key(
        ...
        'p',
        function()
            os.execute("rofi -show calc -modi calc -no-show-match -no-sort")
        end,
        { description = 'Lock the screen', group = 'awesome' }
    ),
    ...
    awful.key({ modkey }, "n", function() awful.util.spawn("brave") end,
        { description = "surf web browser", group = "gui apps" }),
    ...
    awful.key({modkey, "Shift"}, "w", function() awful.spawn.with_shell("~/.config/awesome/changewallpaper.sh") end,
